            ...
            (ot = (function () {
                ...
                return (
                    ...
                    (t.pause = function (t) {
                        t || (this._isPaused = !0),
                            this._element.querySelector(et) &&
                                (Fn.triggerTransitionEnd(this._element),
                                this.cycle(!0)),
                    ...
                    (t._getConfig = function (t) {
                        return (
                            (t = l({}, W, t)), Fn.typeCheckConfig(j, t, U), t
                        );
                    }),
                    ...
                    (o._jQueryInterface = function (i) {
                        return this.each(function () {
                            ...
                            if (
                                (t ||
                                    ((t = new o(this, e)), P(this).data(H, t)),
                                "number" == typeof i)
                            )
                                t.to(i);
                ...
                return (
                    ...
                    (t.show = function () {
                        ...
                        if (
                            ...
                            if (
                                (st(this._element).trigger(i),
                                !i.isDefaultPrevented())
                            ) {
                                t &&
                                    (a._jQueryInterface.call(
                                        st(t).not(this._selector),
                                        "hide"
                                    ),
                                    e || st(t).data(lt, null));
                                ...
                                var o =
                                    ...
                                    s = Fn.getTransitionDurationFromElement(
                                        this._element
                                    );
                                st(this._element)
                                    .one(Fn.TRANSITION_END, function () {
                    ...
                    (t.hide = function () {
                        ...
                        if (
                            ...
                            if (
                                ...
                                this.setTransitioning(!0);
                                this._element.style[n] = "";
                                var a = Fn.getTransitionDurationFromElement(
                                    this._element
                                );
                                st(this._element)
                                    .one(Fn.TRANSITION_END, function () {
                ...
                return (
                    (t.toggle = function () {
                        if (
                            ...
                            if ((c._clearMenus(), !e)) {
                                ...
                                if (
                                    (bt(t).trigger(i), !i.isDefaultPrevented())
                                ) {
                                    if (!this._inNavbar) {
                    ...
                    (t._getPlacement = function () {
                        ...
                        return (
                            t.hasClass(jt)
                                ? ((e = Mt),
                                  bt(this._menu).hasClass(Rt) && (e = Qt))
                                : t.hasClass(Ht)
                                ? (e = Yt)
                                : t.hasClass(Lt)
                                ? (e = zt)
        ...
        Yn =
            ...
            (me = (function () {
                ...
                return (
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var r = Fn.getTransitionDurationFromElement(
                                        this._element
                                    );
                                    $t(this._element)
                                        .one(Fn.TRANSITION_END, function (t) {
                    ...
                    (t._getConfig = function (t) {
                        return (
                            (t = l({}, ie, t)), Fn.typeCheckConfig(Xt, t, re), t
                        );
                    }),
                    (t._showElement = function (t) {
                        ...
                        if (n) {
                            var o = Fn.getTransitionDurationFromElement(
                                this._element
                            );
                            $t(this._dialog)
                    ...
                    (t._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ...
                            : this._isShown ||
                              $t(this._element).off(oe.KEYDOWN_DISMISS);
                    }),
                    ...
                    (t._showBackdrop = function (t) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                return;
                            if (!n) return void t();
                            var i = Fn.getTransitionDurationFromElement(
                                this._backdrop
                            );
                            $t(this._backdrop)
            ...
            (We = (function () {
                ...
                return (
                    ...
                    (t.show = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            var l = function () {
                                ...
                                var t = e._hoverState;
                                (e._hoverState = null),
                                    pe(e.element).trigger(
                                        e.constructor.Event.SHOWN
                                    ),
                                    t === we && e._leave(null, e);
                            };
                            if (pe(this.tip).hasClass(Oe)) {
                                var c = Fn.getTransitionDurationFromElement(
                                    this.tip
                                );
                                pe(this.tip)
                    ...
                    (t.getTipElement = function () {
                        return (
                            (this.tip =
                                this.tip || pe(this.config.template)[0]),
                            this.tip
                        );
                    }),
                    ...
                    (t._enter = function (t, e) {
                        ...
                        (e = e || pe(t.currentTarget).data(n)) ||
                            ...
                            t &&
                                (e._activeTrigger[
                                    "focusin" === t.type ? Le : He
                                ] = !0),
                            pe(e.getTipElement()).hasClass(ke) ||
                            e._hoverState === De
                                ? (e._hoverState = De)
            ...
            (Xe = (function (t) {
                ...
                return (
                    ...
                    (r.getTipElement = function () {
                        return (
                            (this.tip =
                                this.tip || Ue(this.config.template)[0]),
                            this.tip
                        );
                    }),
            ...
            (Tn = (function () {
                ...
                return (
                    ...
                    (t._activate = function (e) {
                        ...
                        n.hasClass(cn)
                            ? (n.closest(pn).find(yn).addClass(hn),
                              n.addClass(hn))
                            : (n.addClass(hn),
                              n
                                  .parents(dn)
